...
void UART_CMD_Process(char *uart_buff) {
    ...
    // Thêm nhận diện lệnh khác ở đây
...
//	  UART_CMD_Process(uart_buff);
	  parseUartBuffer(uart_buff); // Đưa lệnh vào hàng đợi
	}
...
// Phân tích và đưa lệnh vào hàng đợi từ uart_buff
void parseUartBuffer(char *uart_buff) {
